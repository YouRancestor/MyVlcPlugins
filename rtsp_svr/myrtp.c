...
vlc_module_begin ()
    set_shortname( N_("myRTP"))
    set_description( N_("myRTP stream output") )
    set_capability( "sout stream", 110 )
    ...
    add_submodule ()
    set_shortname( N_("myRTSP VoD" ) )
    set_description( N_("myRTSP VoD server") )
    set_category( CAT_SOUT )
