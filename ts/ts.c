...
vlc_module_begin ()
    set_description( N_("MY TS muxer (libdvbpsi)") )
    set_shortname( "MY MPEG-TS")
    set_category( CAT_SOUT )
    set_subcategory( SUBCAT_SOUT_MUX )
    set_capability( "sout mux", 121 )
    add_shortcut( "ts" )
...
//        /*保存文件*/
//        FILE* pFile =NULL;
//        pFile = fopen("C:\\Users\\zYr\\Desktop\\testfiles\\send.ts","ab+");
//        if(pFile)
//            fwrite(p_ts->p_buffer,1,p_ts->i_buffer,pFile);
//        fclose(pFile);
